...
import com.pb.identify.interfaces.RequestExecutor;
...
/**
 * Abstract class for executing rest network calls and handling all kind of
 * network exceptions
 * 
 */
    ...
    protected Response.ErrorListener errorListener = new ErrorListener() {
        ...
        public void onErrorResponse(VolleyError vollyError) {
            ...
            if (response != null && response.data != null) {
                ...
                IdentifyError sesErRs = new IdentifyError();
                ...
                try {
                    ...
                    if (!responseObj.isNull("error")) {
                        ...
                        IdentifyErrorResponse sesErrorResponse = new IdentifyErrorResponse();
                        Errors[] erArray = null;
                        ...
                        sesErrorResponse.setIdentifyError(sesErRs);
                        ...
                        // IDENTIFY specific exceptions handling

                        Gson gson = new Gson();
                        sesErRs = gson.fromJson(responseObj.toString(),
                                IdentifyError.class);

                        Log.d("Got the IdentifyError Response Object" + sesErRs);
